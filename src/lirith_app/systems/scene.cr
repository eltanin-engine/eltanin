  ...
  module Systems
    class Scene < Lirith::Systems::Base
      def initialize
        ...
        if false
          obj_mesh = obj_loader.load(File.open("./src/lirith_app/models/Mountain/Mountain.obj"))
          ...
          obj_mesh.material.texture = Lirith::Texture.new(image: RImage::Formats::Bitmap.new(File.open("./src/lirith_app/models/Mountain/Texture.bmp")))
